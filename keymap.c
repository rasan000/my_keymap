...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(
      ...
      ADJUST,KC_F2,KC_F12,KC_LALT,KC_LGUI,LT(_LOWER,KC_MHEN),LCTL_T(KC_SPC),   RSFT_T(KC_ENT),LT(_RAISE,KC_HENK),KC_SLSH,KC_BSLS,KC_LEFT,KC_DOWN,KC_RGHT
  ),
  ...
  [_RAISE] = LAYOUT(
      ...
      _______, _______, _______, _______, _______, ADJUST, _______,       _______, _______, KC_QUES, KC_PIPE, _______, _______, _______
  ),
  ...
  [_ADJUST] = LAYOUT(
      KC_F1, KC_F2,   KC_F3,   KC_F4, KC_F5,KC_F6,                         _______, LALT(KC_LEFT), KC_WH_U,LALT(KC_RGHT), _______, KC_DEL,
      KC_F7,KC_F8,   KC_F9,   KC_F10, KC_F11, KC_F12,                         _______, KC_WH_L, KC_WH_D, KC_WH_R, _______, _______,
      _______, KC_INS, KC_PSCR, KC_PAUS, _______, _______,                       _______, _______, _______, _______,_______, _______,
